...
class Environment:
    ...
    def readUDMSensors(self, x, y):
        """
        This “real” environment will be encoded in a matrix in the class Environment. The only way
        the drone receives information from this matrix is through the readUDMSensors.
